...
for BETA in "${BETAS[@]}"; do
    ...
    echo "Submitting: J4_i=$J4_I J4_f=$J4_F beta=$BETA"

    sbatch \
        --job-name="kbe_Ji-${J4_I}_Jf-${J4_F}_b-${BETA}_dt-${DT}" \
        --export=ALL,J4_I=$J4_I,J4_F=$J4_F,BETA=$BETA,DT=$DT,T_PRE_FACTOR=$T_PRE_FACTOR,T_POST_FACTOR=$T_POST_FACTOR,CORR_TOL=$CORR_TOL,N_CORR=$N_CORR,ITERATIONS=$ITERATIONS \
        "$WORK_DIR/$SCRIPT"
